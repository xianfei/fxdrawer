...
class PagedList {
  ...
  get onMouseClick() {
    return event_1.Event.map(this.list.onMouseClick, ({
      element,
      index,
      browserEvent
    }) => ({
  ...
  get onMouseDblClick() {
    return event_1.Event.map(this.list.onMouseDblClick, ({
      element,
      index,
      browserEvent
    }) => ({
  ...
  get onTap() {
    return event_1.Event.map(this.list.onTap, ({
      element,
      index,
      browserEvent
    }) => ({
  ...
  get onPointer() {
    return event_1.Event.map(this.list.onPointer, ({
      element,
      index,
      browserEvent
    }) => ({
  ...
  get onDidChangeFocus() {
    return event_1.Event.map(this.list.onDidChangeFocus, ({
      elements,
      indexes,
      browserEvent
    }) => ({
  ...
  get onDidChangeSelection() {
    return event_1.Event.map(this.list.onDidChangeSelection, ({
      elements,
      indexes,
      browserEvent
    }) => ({
  ...
  get onContextMenu() {
    return event_1.Event.map(this.list.onContextMenu, ({
      element,
      index,
      anchor,
      browserEvent

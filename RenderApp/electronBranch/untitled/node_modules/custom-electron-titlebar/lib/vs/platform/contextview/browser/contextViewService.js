...
let ContextViewService = class ContextViewService extends lifecycle_1.Disposable {
  constructor(layoutService) {
    ...
    this.contextView = this._register(new contextview_1.ContextView(this.container, 1
    /* ABSOLUTE */
    ));
    this.layout();
  ...
  showContextView(delegate, container, shadowRoot) {
    if (container) {
      if (container !== this.container) {
        ...
        this.setContainer(container, shadowRoot ? 3
        /* FIXED_SHADOW */
        : 2
        /* FIXED */
        );
...
ContextViewService = __decorate([__param(0, layoutService_1.ILayoutService)], ContextViewService);
